...
import PRINCIPAL.SubmeterArtigo;
...
public class TelaSubmeterArtigo extends javax.swing.JFrame {
    ...
    private void btnAutor1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAutor1ActionPerformed
        ...
        SubmeterArtigo.setTituloArtigo(txtTituloArtigo.getText());
        SubmeterArtigo.setTemaArtigo(txtTemaArtigo.getText());
        SubmeterArtigo.setNomeAutor1(txtNomeAutor1.getText());
        SubmeterArtigo.setNomeAutor2(txtNomeAutor2.getText());
        SubmeterArtigo.setNomeAutor3(txtNomeAutor3.getText());
    ...
    void preencheTela(int aux) {
        if (aux == 1) {
            ...
            try {
                ...
                txtTituloArtigo.setText(SubmeterArtigo.getTituloArtigo());
                txtTemaArtigo.setText(SubmeterArtigo.getTemaArtigo());
                
                if (this.getNautor() == 1) {
                    if (resultado.next()) {
                        txtNomeAutor1.setText(resultado.getString("NOME"));
                        txtNomeAutor2.setText(SubmeterArtigo.getNomeAutor2());
                        txtNomeAutor3.setText(SubmeterArtigo.getNomeAutor3());
                    }
                }
                if (this.getNautor() == 2) {
                    if (resultado.next()) {
                        txtNomeAutor1.setText(SubmeterArtigo.getNomeAutor1());
