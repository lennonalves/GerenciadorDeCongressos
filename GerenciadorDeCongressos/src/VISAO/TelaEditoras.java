    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        try {
            ...
            query.executeUpdate("UPDATE EDITORA SET "
                    + "NOME = '" + txtNomeEditora.getText() + "', "
                    + "CNPJ = '" + txtCNPJEditora.getText() + "', "
                    + "ENDERECO = '" + txtEnderecoEditora.getText() + "', "
                    + "TELEFONE = '" + txtTelefoneEditora.getText() + "', "
                    + "EMAIL = '" + txtEmailEditora.getText() + "' "
                    + "WHERE IDEDITORA = " + getId());
            cx.desconectar();
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try {
            ...
            query.executeUpdate("INSERT INTO EDITORA "
                    ...
                    + "VALUES "
                    + "('" + txtNomeEditora.getText() + "', "
                    + "'" + txtCNPJEditora.getText() + "', "
                    + "'" + txtEnderecoEditora.getText() + "', "
                    + "'" + txtTelefoneEditora.getText() + "', "
                    + "'" + txtEmailEditora.getText() + "')");
            cx.desconectar();
    ...
    void preencheTela(int aux){
        if (aux == 1){
            ...
            try {
                ...
                if (resultado.next()){
                    txtNomeEditora.setText(resultado.getString("NOME"));
                    txtCNPJEditora.setText(resultado.getString("CNPJ"));
                    txtEnderecoEditora.setText(resultado.getString("ENDERECO"));
                    txtTelefoneEditora.setText(resultado.getString("TELEFONE"));
                    txtEmailEditora.setText(resultado.getString("EMAIL"));
                }
                cx.desconectar();
            } catch (SQLException e){
                    JOptionPane.showMessageDialog(null, "ERRO: "+ e.getMessage());
