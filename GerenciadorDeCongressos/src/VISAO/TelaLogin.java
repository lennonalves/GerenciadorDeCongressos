...
import PRINCIPAL.TelaLoginProxy;
import PRINCIPAL.TelaMenuProxy;
...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        TelaLoginProxy ac = new TelaLoginProxy(txtUser.getText(), txtSenha.getText());
//              TelaLoginPoxy ac = TelaLoginProxy.getInstancia();
            
        if (ac.temPermissaoDeAcesso()){
            ...
            try {
                ...
                while(resultado.next()){
                    ...
                    if (resultado.getString("FUNCAO").equals("Avaliador")){
                        ...
                        Avaliador.setIdUser(Integer.parseInt(resultado.getString("IDLOGIN")));
