...
public class TelaCongresso extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        cvo.setNome(txtNomeCongresso.getText());
        cvo.setCnpj(txtCNPJCongresso.getText());
        cvo.setTema(txtTemaCongresso.getText());
        cvo.setEdicao(txtEdicaoCongresso.getText());
        cvo.setArea((String) cbAreaCongresso.getSelectedItem());
        cvo.setNparticipantes(Integer.parseInt(txtNumParticipantes.getText()));
        cvo.setEndereco(txtEnderecoCongresso.getText());
        cvo.setPrazoinscricao(txtPrazoInscricao.getText());
        cvo.setPrazoavaliacao(txtPrazoAvaliacao.getText());
        cvo.setValorinscricao(txtValorInscricao.getText());
        cvo.setIniciocongresso(txtInicioCongresso.getText());
    ...
    void atualizaCampos(int aux){
        if (aux == 1){
            ...
            CongressoVO cvo = CongressoVO.getInstancia();
            CongressoRN crn = CongressoRN.getInstancia();
            String mensagem = crn.atualizaCampos(cvo);

            txtNomeCongresso.setText(cvo.getNome());
            txtCNPJCongresso.setText(cvo.getCnpj());
            txtTemaCongresso.setText(cvo.getTema());
            txtEdicaoCongresso.setText(cvo.getEdicao());
            cbAreaCongresso.setSelectedItem(cvo.getArea());
            txtNumParticipantes.setText(Integer.toString(cvo.getNparticipantes()));
            txtEnderecoCongresso.setText(cvo.getEndereco());
            txtPrazoInscricao.setText(cvo.getPrazoinscricao());
            txtPrazoAvaliacao.setText(cvo.getPrazoavaliacao());
            txtValorInscricao.setText(cvo.getValorinscricao());
            txtInicioCongresso.setText(cvo.getIniciocongresso());
